import{b as e}from"./create-runtime-stories-Dd8eu6kK.js";import"./oitFragment-DNefsNU3.js";import"./harmonicsFunctions-C1Lfb6A2.js";import"./logDepthDeclaration-JE9RLBNP.js";import"./clipPlaneFragment-CdHkP1_n.js";import"./fogFragment-Dwf6MzJH.js";import"./helperFunctions-C2oo9nzJ.js";import"./props-CDwtXEPn.js";import"./index-client-0IVJ1HVs.js";import"./iframe-8l14vsvk.js";import"../sb-preview/runtime.js";import"./index-D-8MO0q_.js";import"./index-BHYIh-Xd.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./meshUboDeclaration-WjSaRnjt.js";const a="pbrFragmentExtraDeclaration",n=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[C]=A;const I="hdrFilteringFunctions",N=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[I]=N;const O="pbrDirectLightingFunctions",T=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
...
`;e.IncludesShadersStoreWGSL[M]=g;const _="pbrBlockReflectivity",D=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;e.IncludesShadersStoreWGSL[_]=D;const F="pbrBlockAmbientOcclusion",P=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[me]=ve;const Re="pbrBlockPrePass",ue=`var writeGeometryInfo: f32=select(0.0,1.0,finalColor.a>ALPHATESTVALUE);var fragData: array<vec4<f32>,SCENE_MRT_COUNT>;
...
#endif
`;e.IncludesShadersStoreWGSL[Re]=ue;const Se="pbrDebug",pe=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[Se]=pe;const r="pbrPixelShader",i=`#define CUSTOM_FRAGMENT_BEGIN
...
`;e.ShadersStoreWGSL[r]=i;const be={name:r,shader:i};export{be as pbrPixelShaderWGSL};
