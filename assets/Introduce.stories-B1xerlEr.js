import{i as f,a as r,t as p}from"./props-CDwtXEPn.js";import{p as j,f as a,a as _,s as e}from"./index-client-0IVJ1HVs.js";import{c as S,C,E as w,S as $,V as l,H as B,d as E}from"./create-runtime-stories-Dd8eu6kK.js";import{F as I}from"./FreeCamera-iAZqn-KU.js";import{G as V,S as F}from"./Sphere-DF57a6bb.js";import"./iframe-8l14vsvk.js";import"../sb-preview/runtime.js";import"./index-D-8MO0q_.js";import"./index-BHYIh-Xd.js";import"./_commonjsHelpers-Cpj98o6Y.js";const G={title:"Introduce",tags:["autodocs"]},{Story:H}=E();var L=p("<!> <!> <!> <!>",1),x=p(`<!> <h1>@juunini/svelte-babylonjs</h1> <h2>Caution</h2> <blockquote><p>❗ This is WIP and not ready for production use.</p></blockquote> <h2>Introduction</h2> Easily create 3D scenes with Babylon.js in Svelte. <h2>Usage</h2> <p>Click under <code>Show code</code> button or to see category</p> <h2>Installation</h2> <code><pre>
...
bun add @juunini/svelte-babylonjs
  </pre></code> <h2>License</h2> MIT`,1);function c(d,m){j(m,!1),f();var n=x(),u=a(n);H(u,{name:"Docs",parameters:{docs:{source:{language:"html",code:`<script lang="ts">
...
</Canvas>`}},children:(h,P)=>{C(h,{style:"width: 100%;",children:(b,k)=>{w(b,{children:(y,z)=>{$(y,{children:(v,M)=>{var o=L(),t=a(o);I(t,{position:new l(0,5,-10)});var s=e(t,2);B(s,{direction:new l(0,1,0),intensity:.7});var i=e(s,2);V(i,{options:{width:6,height:6}});var g=e(i,2);F(g,{options:{diameter:2,segments:32},position:{x:0,y:1,z:0}}),r(v,o)},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0}}),r(d,n),_()}c.__docgen={version:3,name:"Introduce.stories.svelte",data:[],computed:[],methods:[],components:[],description:null,keywords:[],events:[],slots:[],refs:[]};const D=S(c,G),Q=["Docs"],X=D.Docs;export{X as Docs,Q as __namedExportsOrder,G as default};
