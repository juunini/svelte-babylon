...
<p>
  ...
  library to work.
</p>`}}}),K()}O.__docgen={version:3,name:"ExtrudePolygon.stories.svelte",data:[],computed:[],methods:[],components:[],description:null,keywords:[],events:[],slots:[],refs:[]};const ue=Z(O,ye),ze=["Docs"],Ee=ue.Docs;export{Ee as Docs,ze as __namedExportsOrder,ye as default};
