...
</Canvas>`}},children:(o,e=J)=>{ee(o,{style:"width: 100%;",children:(L,le)=>{te(L,{children:(D,ce)=>{ne(D,{physics:!1,children:(H,de)=>{var l=re(),c=Y(l);se(c,{alpha:Math.PI/2,beta:Math.PI/2,radius:10});var d=I(c,2);ie(d,{direction:new y(0,1,0),intensity:.7});var M=I(d,2),O=_(()=>{var u,b,f,h,m,x,k,v,z,w,g,V,S,P,U,E;return{...e().options,shape:(u=e().options)==null?void 0:u.shape.map(t=>new y(t.x,t.y,t.z)),holes:(b=e().options)==null?void 0:b.holes.map(t=>t.map(a=>new y(a.x,a.y,a.z))),faceUV:(h=(f=e().options)==null?void 0:f.faceUV)==null?void 0:h.map(t=>new r(t.x,t.y,t.z,t.w)),frontUVs:(m=e().options)!=null&&m.frontUVs?new r((x=e().options)==null?void 0:x.frontUVs.x,(k=e().options)==null?void 0:k.frontUVs.y,(v=e().options)==null?void 0:v.frontUVs.z,(z=e().options)==null?void 0:z.frontUVs.w):void 0,backUVs:(w=e().options)!=null&&w.backUVs?new r((g=e().options)==null?void 0:g.backUVs.x,(V=e().options)==null?void 0:V.backUVs.y,(S=e().options)==null?void 0:S.backUVs.z,(P=e().options)==null?void 0:P.backUVs.w):void 0,faceColors:(E=(U=e().options)==null?void 0:U.faceColors)==null?void 0:E.map(t=>new oe(t.r,t.g,t.b,t.a))}});j(M,{get options(){return C(O)},get earcutInjection(){return e().earcutInjection},get position(){return e().position},get rotation(){return e().rotation},get scaling(){return e().scaling}}),F(H,l)},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0}}),q()}$.__docgen={version:3,name:"ExtrudePolygon.stories.svelte",data:[],computed:[],methods:[],components:[],description:null,keywords:[],events:[],slots:[],refs:[]};const pe=Q($,ae),ze=["Docs"],we=pe.Docs;export{we as Docs,ze as __namedExportsOrder,ae as default};
