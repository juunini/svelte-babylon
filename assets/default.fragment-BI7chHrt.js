import{a as e}from"./create-runtime-stories-BfL98lhW.js";import"./logDepthDeclaration-Bpliu8zR.js";import"./helperFunctions-e0ivHfZt.js";import"./props-Biv-wkS8.js";import"./index-client-rkuF54Lr.js";import"./iframe-DD4yETVY.js";import"../sb-preview/runtime.js";import"./index-D-8MO0q_.js";import"./index-BHYIh-Xd.js";import"./_commonjsHelpers-Cpj98o6Y.js";const a="prePassDeclaration",i=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]=i;const o="oitDeclaration",f=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;e.IncludesShadersStoreWGSL[o]=f;const n="lightUboDeclaration",s=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
`;e.IncludesShadersStoreWGSL[p]=u;const m="fresnelFunction",h=`#ifdef FRESNEL
fn computeFresnelTerm(viewDirection: vec3f,worldNormal: vec3f,bias: f32,power: f32)->f32
{let fresnelTerm: f32=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStoreWGSL[m]=h;const S="reflectionFunction",g=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[S]=g;const x="imageProcessingDeclaration",w=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[x]=w;const C="imageProcessingFunctions",I=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;e.IncludesShadersStoreWGSL[C]=I;const E="bumpFragmentMainFunctions",T=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[E]=T;const L="bumpFragmentFunctions",D=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[L]=D;const P="clipPlaneFragmentDeclaration",A=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[P]=A;const X="fogFragmentDeclaration",M=`#ifdef FOG
...
#endif
`;e.IncludesShadersStoreWGSL[X]=M;const N="clipPlaneFragment",_=`#if defined(CLIPPLANE) || defined(CLIPPLANE2) || defined(CLIPPLANE3) || defined(CLIPPLANE4) || defined(CLIPPLANE5) || defined(CLIPPLANE6)
if (false) {}
#endif
#ifdef CLIPPLANE
...
{discard;}
#endif
`;e.IncludesShadersStoreWGSL[N]=_;const y="bumpFragment",F=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[y]=F;const O="decalFragment",R=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[O]=R;const b="depthPrePass",z=`#ifdef DEPTHPREPASS
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);return fragmentOutputs;
#endif
`;e.IncludesShadersStoreWGSL[b]=z;const W="lightFragment",U=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[W]=U;const V="logDepthFragment",G=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStoreWGSL[V]=G;const H="fogFragment",B=`#ifdef FOG
...
#endif
`;e.IncludesShadersStoreWGSL[H]=B;const k="oitFragment",Y=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[k]=Y;const r="defaultPixelShader",t=`#include<defaultUboDeclaration>
...
`;e.ShadersStoreWGSL[r]=t;const ae={name:r,shader:t};export{ae as defaultPixelShaderWGSL};
