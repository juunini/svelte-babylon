import{a as e}from"./create-runtime-stories-DlYX6Gso.js";import"./oitFragment-DwtLtn7T.js";import"./defaultUboDeclaration-BhCJN0U8.js";import"./logDepthDeclaration-B0s3Zqi1.js";import"./helperFunctions-DSAMiMOV.js";import"./fogFragment-Dl0_Btz7.js";import"./props-CDwtXEPn.js";import"./index-client-0IVJ1HVs.js";import"./iframe-DXvAOt9X.js";import"../sb-preview/runtime.js";import"./index-D-8MO0q_.js";import"./index-BHYIh-Xd.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./meshUboDeclaration-DyuqaOu_.js";const r="defaultFragmentDeclaration",f=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
return result;}
#define inline
vec3 computeProjectionTextureDiffuseLighting(sampler2D projectionLightSampler,mat4 textureProjectionMatrix,vec3 posW){vec4 strq=textureProjectionMatrix*vec4(posW,1.0);strq/=strq.w;vec3 textureColor=texture2D(projectionLightSampler,strq.xy).rgb;return textureColor;}`;e.IncludesShadersStore[n]=t;const l="fresnelFunction",a=`#ifdef FRESNEL
...
`;e.ShadersStore[i]=o;const P={name:i,shader:o};export{P as defaultPixelShader};
