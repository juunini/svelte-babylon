import{S as e}from"./create-runtime-stories-ChL5sEf5.js";const i="bonesDeclaration",a=`#if NUM_BONE_INFLUENCERS>0
...
#endif
`;e.IncludesShadersStore[x]=A;const S="vertexColorMixing",I=`#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
vColor=vec4(1.0);
#ifdef VERTEXCOLOR
#ifdef VERTEXALPHA
vColor*=color;
