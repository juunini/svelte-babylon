...
<p>
  ...
  library to work.
</p>`}}}),K()}O.__docgen={version:3,name:"ExtrudePolygon.stories.svelte",data:[],computed:[],methods:[],components:[],description:null,keywords:[],events:[],slots:[],refs:[]};const ue=Z(O,ce),ze=["Docs"],Se=ue.Docs;export{Se as Docs,ze as __namedExportsOrder,ce as default};
