import{a as e}from"./create-runtime-stories-DlYX6Gso.js";import"./oitFragment-DwtLtn7T.js";import"./harmonicsFunctions-BcnbYagv.js";import"./logDepthDeclaration-B0s3Zqi1.js";import"./fogFragment-Dl0_Btz7.js";import"./helperFunctions-DSAMiMOV.js";import"./props-CDwtXEPn.js";import"./index-client-0IVJ1HVs.js";import"./iframe-DXvAOt9X.js";import"../sb-preview/runtime.js";import"./index-D-8MO0q_.js";import"./index-BHYIh-Xd.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./meshUboDeclaration-DyuqaOu_.js";const a="pbrFragmentDeclaration",o=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
#endif
`;e.IncludesShadersStore[u]=m;const A="pbrDirectLightingSetupFunctions",S=`struct preLightingInfo
...
#endif
return result;}`;e.IncludesShadersStore[A]=S;const v="pbrDirectLightingFalloffFunctions",I=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[v]=I;const N="pbrBRDFFunctions",T=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
`;e.IncludesShadersStore[L]=g;const _="pbrIBLFunctions",M=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[_]=M;const h="pbrBlockAlbedoOpacity",D=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[h]=D;const F="pbrBlockReflectivity",P=`struct reflectivityOutParams
...
#endif
`;e.IncludesShadersStore[ue]=me;const Ae="pbrBlockPrePass",Se=`float writeGeometryInfo=finalColor.a>ALPHATESTVALUE ? 1.0 : 0.0;
...
#endif
#endif
`;e.IncludesShadersStore[Ae]=Se;const ve="pbrDebug",Ie=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[ve]=Ie;const i="pbrPixelShader",n=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[i]=n;const Be={name:i,shader:n};export{Be as pbrPixelShader};
