import{a as e}from"./create-runtime-stories-BkvPK9tB.js";import"./logDepthDeclaration-CGNv80UW.js";import"./helperFunctions-BSo-s8Ln.js";import"./fogFragment-B95KU1bf.js";import"./props-D_CwaEcb.js";import"./index-client-a4XWVA08.js";import"./iframe-DOBaK8HO.js";import"../sb-preview/runtime.js";import"./index-D-8MO0q_.js";import"./index-BHYIh-Xd.js";import"./_commonjsHelpers-Cpj98o6Y.js";const a="prePassDeclaration",i=`#ifdef PREPASS
...
#endif
`;e.IncludesShadersStoreWGSL[c]=v;const u="samplerFragmentDeclaration",p=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[u]=p;const h="fresnelFunction",m=`#ifdef FRESNEL
fn computeFresnelTerm(viewDirection: vec3f,worldNormal: vec3f,bias: f32,power: f32)->f32
{let fresnelTerm: f32=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStoreWGSL[h]=m;const S="reflectionFunction",g=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[x]=w;const C="imageProcessingFunctions",T=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;e.IncludesShadersStoreWGSL[C]=T;const I="bumpFragmentMainFunctions",E=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[I]=E;const D="bumpFragmentFunctions",L=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[D]=L;const A="bumpFragment",P=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[A]=P;const X="decalFragment",M=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[X]=M;const _="depthPrePass",N=`#ifdef DEPTHPREPASS
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);return fragmentOutputs;
#endif
`;e.IncludesShadersStoreWGSL[_]=N;const y="lightFragment",R=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[y]=R;const O="logDepthFragment",F=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStoreWGSL[O]=F;const b="oitFragment",z=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[b]=z;const r="defaultPixelShader",t=`#include<defaultUboDeclaration>
...
`;e.ShadersStoreWGSL[r]=t;const q={name:r,shader:t};export{q as defaultPixelShaderWGSL};
