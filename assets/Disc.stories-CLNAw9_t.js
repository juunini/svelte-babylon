...
</Canvas>`}}}),T()}E.__docgen={version:3,name:"Disc.stories.svelte",data:[],computed:[],methods:[],components:[],description:null,keywords:[],events:[],slots:[],refs:[]};const ie=K(E,te),fe=["Docs"],me=ie.Docs;export{me as Docs,fe as __namedExportsOrder,te as default};
