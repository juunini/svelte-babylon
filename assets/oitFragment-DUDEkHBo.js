import{a as e}from"./create-runtime-stories-BDqFloR4.js";const t="prePassDeclaration",a=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]=a;const r="oitDeclaration",i=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;e.IncludesShadersStoreWGSL[r]=i;const o="lightUboDeclaration",f=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[o]=f;const s="shadowsFragmentFunctions",n=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
return vec4f(rgb,result.a);}`;e.IncludesShadersStoreWGSL[c]=m;const S="bumpFragmentMainFunctions",g=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[S]=g;const x="bumpFragmentFunctions",w=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[x]=w;const T="bumpFragment",X=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[T]=X;const L="decalFragment",D=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[L]=D;const I="depthPrePass",C=`#ifdef DEPTHPREPASS
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);return fragmentOutputs;
#endif
`;e.IncludesShadersStoreWGSL[I]=C;const P="lightFragment",E=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[P]=E;const y="logDepthFragment",M=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStoreWGSL[y]=M;const A="oitFragment",F=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[A]=F;
